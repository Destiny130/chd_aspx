...
public partial class MasterPages_Layout : System.Web.UI.MasterPage
{
    ...
    {
        navtime1.Text = DateTime.Now.ToShortTimeString();
        navtime2.Text = navtime1.Text;
        if (Request.IsAuthenticated)
        {
            LoginLink.Visible = false;
            detailsTableRow.Visible = true;

            User user = myEntities.Users.Where(u => u.UserName == Page.User.Identity.Name).Single();
