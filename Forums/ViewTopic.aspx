<%@ Page Title="View Topic" Language="C#" MasterPageFile="~/MasterPages/Layout.master" AutoEventWireup="true" CodeFile="ViewTopic.aspx.cs" Inherits="Forums_ViewTopic" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent1" runat="Server">
    ...
    <div class="table90 textcenter" runat="server" id="Top">
        ...
        <asp:Label ID="TopicTitleLabel" runat="server"></asp:Label>
        <br />
    </div>
    <br />
    <asp:Table runat="server" CssClass="table90 textleft" ID="countAndNewTopic">
        <asp:TableRow>
            ...
            <asp:TableCell CssClass="padding5 textright">
                <asp:Button runat="server" ID="NewReplyButton" Text="新回复" OnClick="NewReplyButton_Click" Visible="false" />
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" SelectMethod="ListView1_GetData" ItemType="ForumReply" InsertItemPosition="LastItem" InsertMethod="ListView1_InsertItem" DeleteMethod="ListView1_DeleteItem" OnItemDataBound="ListView1_ItemDataBound" OnPreRender="ListView1_PreRender">
        <InsertItemTemplate>
            <br />
            <asp:Table runat="server" CssClass="table100">
                <asp:TableRow ID="ReplyRow" Visible="false">
                    <asp:TableCell CssClass="table100 textcenter">
                        <br />
                        <li class="table50 border padding10 textcenter">快速回复<br />
                            <asp:TextBox ID="ReplyText" runat="server" Text='<%# BindItem.ReplyContent %>' TextMode="MultiLine" Width="450px" Height="145px"></asp:TextBox><br />
                ...
                <asp:TableRow ID="LoginRow">
                    <asp:TableCell>若要回复，请先<a href="../Login.aspx" class="bold underline">登录</a>.</asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </InsertItemTemplate>
        <ItemTemplate>
                    ...
                    <table class="table98  padding5 textleft">
                        <tr>
                            <td class="padding10" id='<%# Item.Id %>'>
                                <asp:Label ID="ReplyId" runat="server" Text='<%# "#" + Item.Id %>'></asp:Label>
                                <asp:HyperLink ID="AuthorLink" runat="server" NavigateUrl="<%# GetAuthorInfo(Item.UserName) %>" Text="<%# Item.UserName %>" />
                                <asp:Label ID="ReplyDate" runat="server" Text='<%# Item.CreateDateTime %>'></asp:Label>
                            </td>
                            <td class="textright padding10">
                                <asp:Label ID="FloorLabel" runat="server" Text='<%# GetFloor(Item.Id) + "楼" %>'></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table class="table98 textleft">
                        <tr>
                            ...
                            <td class="borderdeepcolor padding10" style="vertical-align: top;">
                                <asp:Label ID="ReplyLabel" runat="server" Text='<%# Item.ReplyContent %>' />
                            </td>
                        </tr>
                        <tr>
                            <td class="borderdeepcolor padding5">off on repost</td>
                            <td class="borderdeepcolor padding5 textright">
                                <asp:Button ID="QuoteButton" runat="server" Text="引用" PostBackUrl='<%# "~/Forums/ForumQuote.aspx?Id=" + Item.Id  %>' Visible="false" />
